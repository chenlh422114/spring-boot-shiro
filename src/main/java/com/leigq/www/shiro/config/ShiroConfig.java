...
public class ShiroConfig {
	...
	/*
	 * private String host = "localhost"; private int port = 6379; private String
	 * password; private Duration timeout;
	 */
	private String host;
	private int port;
	...
	/**
	 * Filter工厂，设置对应的过滤条件和跳转条件 create by: leigq create time: 2019/7/3 14:29
	 *
	...
	public ShiroFilterFactoryBean shirFilter(SecurityManager securityManager) {
		...
		/*
		 * anon:所有url都都可以匿名访问，authc:所有url都必须认证通过才可以访问; 过滤链定义，从上向下顺序执行，authc 应放在 anon 下面
		 */
	...
	/**
	 * 凭证匹配器（由于我们的密码校验交给Shiro的SimpleAuthenticationInfo进行处理了） create by: leigq create
	 * time: 2019/7/3 14:30
	 *
	...
	/**
	 * 将自己的验证方式加入容器 create by: leigq create time: 2019/7/3 14:30
	 *
	 * @return MyShiroRealm
	 */
	@Bean
	...
	/**
	 * RedisSessionDAO shiro sessionDao层的实现 通过redis, 使用的是shiro-redis开源插件 create by:
	 * leigq create time: 2019/7/3 14:30
	 *
	...
	/**
	 * 自定义sessionManager create by: leigq create time: 2019/7/3 14:31
	 *
	...
	/**
	 * create by: leigq description: 权限管理，配置主要是Realm的管理认证 create time: 2019/7/1
	 * 10:09
	 *
	...
	/**
	 * create by: leigq description: 异常处理,
	 * 详见：https://www.cnblogs.com/libra0920/p/6289848.html create time: 2019/7/1
	 * 10:28
	 * 
